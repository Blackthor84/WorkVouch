...
export default function PreviewOnlyClient() {
  ...
  if (roleCheck === "other") return null;
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-yellow-700 mt-1">You're viewing WorkVouch in preview mode. Subscription features are disabled.</p>
            </div>
            <Link href="/login" className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition">Sign Up for Full Access</Link>
          </div>
        </div>
      </div>
      <div className="max-w-7xl mx-auto py-10 px-4">
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-700 mb-4">You have temporary preview access to explore WorkVouch. This allows you to:</p>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg p-8 text-white text-center">
          ...
          <p className="mb-6 opacity-90">Sign up for a full account to start verifying your work history or hiring with confidence.</p>
          <Link href="/signup" className="inline-block px-8 py-3 bg-white text-blue-600 font-semibold rounded-lg hover:bg-gray-100 transition shadow-lg">Sign Up for Full Access</Link>
        </div>
      </div>
    </div>
  );
