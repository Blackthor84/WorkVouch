...
export default function IndustryJobStep() {
  ...
  const handleNext = async () => {
    ...
    try {
      ...
      router.push(`/onboarding/${industry}/coworkers`)
    } catch (err: any) {
            ...
            <div className="space-y-4 mb-6">
              ...
              <div>
                ...
                <Input
                  id="employer"
                  type="text"
                  placeholder="e.g., ABC Security, XYZ Retail"
                  value={employer}
              ...
              <div>
                ...
                <Input
                  id="certifications"
                  type="text"
                  placeholder="e.g., Security License, CPR, First Aid"
