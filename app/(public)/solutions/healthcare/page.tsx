...
export const metadata = {
  title: "WorkVouch for Healthcare Staffing",
  description: "Verify clinical roles, credentials, and employment history for healthcare staffing.",
};
    ...
    <div className="min-h-screen bg-background dark:bg-[#0D1117]">
      <section className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:py-24">
        <h1 className="text-3xl font-bold tracking-tight text-grey-dark dark:text-gray-200 sm:text-4xl">
          Healthcare Staffing Verification
        </h1>
        <p className="mt-4 text-grey-medium dark:text-gray-400">
          Verify clinical roles, credentials, and employment history. Same WorkVouch verification engine and plan enforcement—framed for healthcare staffing.
        </p>
        <ul className="mt-6 list-disc list-inside space-y-2 text-grey-medium dark:text-gray-400">
          <li>Peer-confirmed employment at facilities</li>
          <li>Credential and certification validation</li>
