...
export const metadata = {
  title: "WorkVouch for Hospitality",
  description: "Front-line and management verification across properties.",
};
    ...
    <div className="min-h-screen bg-background dark:bg-[#0D1117]">
      <section className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:py-24">
        ...
        <p className="mt-4 text-grey-medium dark:text-gray-400">
          Verify front-line and management roles across properties. Same WorkVouch verification engine and plan enforcement—framed for hospitality.
        </p>
        <ul className="mt-6 list-disc list-inside space-y-2 text-grey-medium dark:text-gray-400">
          ...
          <li>Tenure and reference strength</li>
