  ...
  const features = [
    {
      ...
      description:
        "No fake references. Every job on your profile is verified by people who actually worked with you. Build trust with employers through authentic peer verification.",
    },
    {
      icon: ChartBarIcon,
    ...
    },
    {
      ...
      description:
        "Your career profile is stored securely with enterprise-grade encryption. You control who sees what. Your privacy is our priority.",
    },
    {
      icon: BuildingOfficeIcon,
      title: "Industry-Specific",
      description:
        "Tailored for law enforcement, security, hospitality, retail, and warehousing. Industry-specific fields, certifications, and verification processes designed for your field.",
    },
    {
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-grey-medium dark:text-gray-400 max-w-2xl mx-auto">
              Everything you need to build a verified, trustworthy career
              profile that employers trust
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            ...
            <p className="text-grey-medium dark:text-gray-400 mb-6">
              Start building your verified career profile today. It's free to
              get started.
            </p>
            <a
              href="/auth/signup"
