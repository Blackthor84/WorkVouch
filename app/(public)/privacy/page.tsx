            ...
            <div className="bg-white dark:bg-[#1A1F2B] rounded-2xl shadow-md p-8 space-y-6 text-grey-medium dark:text-gray-400">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-1 ml-4">
                      ...
                      <li>
                        Profile information (job history, skills,
                        certifications)
                      </li>
              ...
              <section>
                ...
                <p className="mb-4">
                  ...
                  with enterprise-grade encryption. Data may be stored in
                  multiple geographic locations for redundancy.
                </p>
                <p>
                  Payment information is processed through Stripe, a PCI-DSS
                  Level 1 certified payment processor. We do not store full
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-1 ml-4">
                      ...
                      <li>
                        Right to opt-out of sale (WorkVouch does not sell
              ...
              <section>
                ...
                <p className="mb-4">
                  ...
                  (AES-256). We conduct regular security audits and monitor for
                  security threats.
                </p>
                <p>
              ...
              <div className="mt-8 pt-6 border-t border-grey-background dark:border-[#374151]">
                <p className="text-sm text-grey-medium dark:text-gray-400">
                  ...
                  information about data retention, cookies, employer access,
