  ...
  useEffect(() => {
    ...
    const channel = supabaseBrowser
      ...
      .on(
        ...
        (payload: { new?: { user_1: string; user_2: string } }) => {
          const row = payload.new;
          if (!row) return;
          const isForCurrentUser = row.user_1 === currentUser.id || row.user_2 === currentUser.id;
    ...
    <div className="p-4 sm:p-6 md:p-8 max-w-4xl mx-auto">
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          title="Add a coworker to get your first vouch"
          description="Add roles with accurate dates—we match on real employment overlap, then you can request a vouch from anyone we surface."
          action={
