-- ============================================================================
-- ADD EMPLOYER ACCOUNT CREATION TO SIGNUP TRIGGER
-- ============================================================================
-- This updates the handle_new_user() function to automatically create
-- employer_accounts entries when an employer signs up
-- ============================================================================

-- Update the handle_new_user function to create employer_accounts
...
BEGIN
  ...
  RAISE NOTICE 'It now automatically creates employer_accounts entries for employers.';
END $$;
