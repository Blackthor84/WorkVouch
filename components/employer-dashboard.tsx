      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        <Card className="p-6">
          ...
          <p className="text-sm text-grey-medium dark:text-gray-400 mb-4">
            Find and verify candidate profiles with our comprehensive search
            tool.
          </p>
        ...
        <Card className="p-6">
          ...
          <p className="text-sm text-grey-medium dark:text-gray-400 mb-4">
            You have {purchases.filter((p) => p.status === "completed").length}{" "}
            completed purchase
            {purchases.filter((p) => p.status === "completed").length !== 1
              ? "s"
              : ""}
            .
          </p>
