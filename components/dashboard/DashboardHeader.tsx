      ...
      <div className="relative">
        ...
        {isNewUser ? (
          <p className="mt-4 text-lg text-white/95 font-medium max-w-xl">
            Start building your reputation — add a job, find coworkers, and get verified.
          </p>
        ) : !hasReputationSignal ? (
          <>
            <p className="mt-4 text-lg text-white/95 font-medium max-w-xl">
              Start building your trust profile — add jobs, match coworkers, and collect verifications.
            </p>
