...
import { saveCandidate, unsaveCandidate, isCandidateSaved } from '@/lib/actions/employer/saved-candidates'
import { sendMessage } from '@/lib/actions/employer/messages'
import { Card } from '../ui/card'
import { Button } from '../ui/button'
import { BookmarkIcon, BookmarkSlashIcon, PaperAirplaneIcon, CheckBadgeIcon } from '@heroicons/react/24/outline'
...
export function CandidateProfileViewer({ candidateData }: CandidateProfileViewerProps) {
        ...
        <Card className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {industry_fields.map((field: any, idx: number) => (
              <div key={idx} className="p-4 bg-grey-background dark:bg-[#1A1F2B] rounded-xl">
