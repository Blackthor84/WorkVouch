...
import { getSavedCandidates, unsaveCandidate } from '@/lib/actions/employer/saved-candidates'
  ...
  if (loading) {
    return (
      <Card className="p-12 text-center">
        <p className="text-grey-medium dark:text-gray-400">Loading saved candidates...</p>
      </Card>
    )
  }
    ...
    return (
      <Card className="p-12 text-center">
        <p className="text-grey-medium dark:text-gray-400">
          No saved candidates yet. Start searching and save candidates you're interested in.
        </p>
      </Card>
    )
  }
                ...
                <div className="flex items-center gap-4 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-grey-dark dark:text-gray-200 mt-1">
                      Trust Score: <span className="text-blue-600 dark:text-blue-400">{trustScore}</span>
                    </p>
                  </div>
                </div>
                {saved.notes && (
