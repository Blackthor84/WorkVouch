...
export function EmployerSidebar() {
  ...
  const navItems = [
    ...
    { href: '/employer/candidates', label: 'Candidates', icon: MagnifyingGlassIcon },
    { href: '/employer/job-posts', label: 'Job Posts', icon: BriefcaseIcon },
    { href: '/employer/messages', label: 'Messages', icon: ChatBubbleLeftRightIcon },
  ...
  return (
    <aside className="w-64 bg-white dark:bg-[#111827] border-r border-grey-background dark:border-[#374151] min-h-screen p-4">
      <div className="mb-6">
        <h2 className="text-lg font-bold text-grey-dark dark:text-gray-200">Employer Panel</h2>
      </div>
