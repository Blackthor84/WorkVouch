...
import { BriefcaseIcon, BuildingOfficeIcon, CalendarIcon, MapPinIcon, TrashIcon, UserGroupIcon } from '@heroicons/react/24/outline'
...
export function JobsSection({ jobs }: { jobs: Job[] }) {
  ...
  return (
    <Card>
      ...
      {showForm && (
        <form onSubmit={handleSubmit} className="space-y-6 pt-4 border-t border-gray-200">
          <div>
      ...
      <div className="space-y-4 pt-4 border-t border-gray-200">
        {jobs.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-sm text-gray-900 mt-2 font-semibold">Add your first job to get started.</p>
          </div>
        ) : (
          jobs.map((job) => (
            <div
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-900 font-semibold">{job.company_name}</p>
                    </div>
                  </div>
