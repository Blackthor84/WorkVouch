  ...
  const getIcon = (type: string) => {
    switch (type) {
      ...
      case 'reference_received':
        return <DocumentTextIcon className="h-5 w-5 text-green-600 dark:text-green-400" />
      ...
      default:
        return <BellIcon className="h-5 w-5 text-grey-medium dark:text-gray-400" />
    }
  }
      ...
      <Card>
        <div className="text-center py-12">
          <p className="text-grey-medium dark:text-gray-400">
            No notifications yet. You'll see updates here when you have new matches or references.
          </p>
        </div>
      </Card>
    )
