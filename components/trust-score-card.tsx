...
export async function TrustScoreCard({ userId }: { userId: string }) {
  ...
  return (
    <Card className="relative overflow-hidden">
      <div className={`absolute top-0 left-0 right-0 h-1 ${getScoreBgColor(score)}`}></div>
      <CardHeader>
        <div className="flex items-center justify-between">
          <CardTitle>Trust Score</CardTitle>
          <button className="text-grey-medium dark:text-gray-400 hover:text-grey-medium dark:text-gray-400 transition-colors" title="What affects your Trust Score?">
      ...
      <CardContent>
        {trustScore ? (
          <div className="space-y-6">
              ...
              <div className="relative h-40 w-40">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <div className="text-xs text-grey-dark dark:text-gray-200 font-semibold mt-1">out of 1000</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Score Label */}
            <div className="text-center">
              <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full ${getScoreBgColor(score)}/10`}>
                <div className={`h-2 w-2 rounded-full ${getScoreBgColor(score)}`}></div>
            ...
            <div className="pt-4 border-t border-grey-background dark:border-[#374151]">
              <p className="text-xs text-grey-dark dark:text-gray-200 font-semibold mb-2">Score History</p>
